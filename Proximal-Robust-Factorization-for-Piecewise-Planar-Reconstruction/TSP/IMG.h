...
public:
   ...
   void move_merge_IMG();
   void move_split_IMG();
   void move_refine_IMG();
   void move_IMG();
   void Flow_QP();
   void Flow_QP2();
   void find_SxySyy(arr(int) all2alive, arr(int) alive2all, arr(int) all2dead, arr(int) dead2all);
   bool move_refine_SP(int k1, int k2);
   void move_refine_SP(int k1);



   void Match_Gating(arr(double) pre_mean ,int SP_ind, linkedList<int> &gating, arr(double) thres);
   void Match_Gating(arr(double) pre_mean, int k,linkedList<int> &gating,arr(double) thres,arr(bool) checked);
   /*void Match_BIP(arr(double) thres,bool l1);
   void Match_BIP2(arr(double) thres,bool l1);*/
   void Test_gating(int ind,arr(double) thres);
private:
   //
   // -- 1. I/O
   void U_initialize();
